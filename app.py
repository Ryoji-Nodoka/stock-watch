...
STOCK_MASTER = {
    "1605": {"name": "INPEX",                          "sector": "石油・石炭製品", "type": "cyclical",  "dividend": 100.0},
    "1925": {"name": "大和ハウス工業",                  "sector": "建設業",         "type": "cyclical",  "dividend": 155.0},
    "2502": {"name": "アサヒグループホールディングス",   "sector": "食料品",         "type": "defensive", "dividend": 53.0},
    "2503": {"name": "キリンホールディングス",           "sector": "食料品",         "type": "defensive", "dividend": 74.0},
    "2914": {"name": "日本たばこ産業（JT）",             "sector": "食料品",         "type": "defensive", "dividend": 234.0},
    "4063": {"name": "信越化学工業",                    "sector": "化学",           "type": "cyclical",  "dividend": 106.0},
    "4452": {"name": "花王",                            "sector": "化学",           "type": "defensive", "dividend": 154.0},
    "4502": {"name": "武田薬品工業",                    "sector": "医薬品",         "type": "defensive", "dividend": 198.0},
    "4503": {"name": "アステラス製薬",                  "sector": "医薬品",         "type": "defensive", "dividend": 76.0},
    "5019": {"name": "出光興産",                        "sector": "石油・石炭製品", "type": "cyclical",  "dividend": 36.0},
    "5020": {"name": "ENEOSホールディングス",            "sector": "石油・石炭製品", "type": "cyclical",  "dividend": 30.0},
    "5108": {"name": "ブリヂストン",                    "sector": "ゴム製品",       "type": "cyclical",  "dividend": 115.0},
    "6301": {"name": "小松製作所（コマツ）",             "sector": "機械",           "type": "cyclical",  "dividend": 202.0},
    "6454": {"name": "マックス",                        "sector": "機械",           "type": "cyclical",  "dividend": 28.5},
    "6501": {"name": "日立製作所",                      "sector": "電気機器",       "type": "cyclical",  "dividend": 45.0},
    "6503": {"name": "三菱電機",                        "sector": "電気機器",       "type": "cyclical",  "dividend": 55.0},
    "6758": {"name": "ソニーグループ",                  "sector": "電気機器",       "type": "cyclical",  "dividend": 22.5},
    "6902": {"name": "デンソー",                        "sector": "輸送用機器",     "type": "cyclical",  "dividend": 64.0},
    "7203": {"name": "トヨタ自動車",                    "sector": "輸送用機器",     "type": "cyclical",  "dividend": 95.0},
    "7267": {"name": "本田技研工業（ホンダ）",           "sector": "輸送用機器",     "type": "cyclical",  "dividend": 69.0},
    "7751": {"name": "キヤノン",                        "sector": "精密機器",       "type": "cyclical",  "dividend": 160.0},
    "8001": {"name": "伊藤忠商事",                      "sector": "卸売業",         "type": "cyclical",  "dividend": 40.0},
    "8002": {"name": "丸紅",                            "sector": "卸売業",         "type": "cyclical",  "dividend": 100.0},
    "8015": {"name": "豊田通商",                        "sector": "卸売業",         "type": "cyclical",  "dividend": 55.0},
    "8031": {"name": "三井物産",                        "sector": "卸売業",         "type": "cyclical",  "dividend": 105.0},
    "8053": {"name": "住友商事",                        "sector": "卸売業",         "type": "cyclical",  "dividend": 135.0},
    "8058": {"name": "三菱商事",                        "sector": "卸売業",         "type": "cyclical",  "dividend": 105.0},
    "8306": {"name": "三菱UFJフィナンシャルグループ",    "sector": "銀行業",         "type": "cyclical",  "dividend": 74.0},
    "8316": {"name": "三井住友フィナンシャルグループ",   "sector": "銀行業",         "type": "cyclical",  "dividend": 157.0},
    "8411": {"name": "みずほフィナンシャルグループ",     "sector": "銀行業",         "type": "cyclical",  "dividend": 147.5},
    "8591": {"name": "オリックス",                      "sector": "その他金融業",   "type": "cyclical",  "dividend": 151.6},
    "8802": {"name": "三菱地所",                        "sector": "不動産業",       "type": "cyclical",  "dividend": 45.0},
    "9020": {"name": "東日本旅客鉄道（JR東日本）",       "sector": "陸運業",         "type": "defensive", "dividend": 69.0},
    "9432": {"name": "NTT（日本電信電話）",              "sector": "情報・通信業",   "type": "defensive", "dividend": 5.25},
    "9433": {"name": "KDDI",                            "sector": "情報・通信業",   "type": "defensive", "dividend": 77.5},
    "9501": {"name": "東京電力ホールディングス",          "sector": "電気・ガス業",   "type": "defensive", "dividend": 0.0},
    "9503": {"name": "関西電力",                        "sector": "電気・ガス業",   "type": "defensive", "dividend": 60.0},
    "9531": {"name": "東京ガス",                        "sector": "電気・ガス業",   "type": "defensive", "dividend": 95.0},
    "9984": {"name": "ソフトバンクグループ",             "sector": "情報・通信業",   "type": "cyclical",  "dividend": 11.0},
}
...
INITIAL_STOCKS = [
    ...
    ("8058", "三菱商事",                     "卸売業",         "cyclical",  105.0, 5.0),
    ("8031", "三井物産",                     "卸売業",         "cyclical",  105.0, 5.0),
    ("9432", "NTT（日本電信電話）",           "情報・通信業",   "defensive",  5.25, 5.0),
    ("8316", "三井住友フィナンシャルグループ", "銀行業",         "cyclical",  157.0, 5.0),
    ("5020", "ENEOSホールディングス",         "石油・石炭製品", "cyclical",   30.0, 5.0),
    ("8053", "住友商事",                     "卸売業",         "cyclical",  135.0, 5.0),
    ("2914", "日本たばこ産業（JT）",          "食料品",         "defensive", 234.0, 5.0),
    ("4502", "武田薬品工業",                 "医薬品",         "defensive", 198.0, 5.0),
]
